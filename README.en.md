...
- Node IDs are generated by the service. Node addresses and the health-check interval are stored in `data/config.db`.
- Nodes are checked every 60 seconds by default. The interval can be changed in the Web interface from 5 to 3600 seconds.
