...
class DesktopContractTests(TestCase):
    ...
    def test_settings_and_local_asset_frontend_contract(self):
        ...
        self.assertIn('addEventListener("mousedown"', app_js)
        self.assertIn('addEventListener("touchstart"', app_js)
        self.assertNotIn('setPointerCapture', app_js)
        self.assertIn('data-lucide="grip-horizontal"', index)
